...
import logging
import random
from sorular import D_LIST, C_LIST
...
async def _(client, callback_query):
	d_soru=random.choice(D_LIST) # Random Bir Doğruluk Sorusu Seçelim
	c_soru=random.choice(C_LIST) # Random Bir Cesaret Sorusu Seçelim
